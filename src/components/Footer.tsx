    ...
    <footer className="bg-muted/50 border-t border-border">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Transform 2D floor plans into interactive 3D visualizations.
              Upload, generate, and explore your spaces.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                className="h-9 w-9 rounded-md bg-muted flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-accent transition-colors"
                aria-label="GitHub"
              >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <p>© {year} Floor3D. All rights reserved.</p>
